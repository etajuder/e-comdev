...
<div class="container">
	<div class="col-sm-12">
		<h2><i class="ion-ios-cart orange"></i> Add Your Auction</h2>
		<hr>
		<form action="<?=base_url()?>auction/addProcess" method="POST" enctype="multipart/form-data">
			...
			<div class="row form-group">
				...
				<div class="col-sm-2">
					<div class="input-group">
						...
						<input type="text" class="form-control" name="amount_bid" id="password" required="" placeholder="">
					</div>
				</div>
			</div>
			<div class="row form-group">
