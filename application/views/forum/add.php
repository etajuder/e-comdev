...
<div class="container">
	<div class="col-sm-12">
		...
		<hr>
		<form action="<?=base_url()?>forum/addProcess" method="POST" enctype="multipart/form-data">
			...
			<div class="row form-group">
				<div class="col-sm-10 col-sm-offset-2">
					...
					<button type="button" class="btn btn-warning btn-md" onclick="document.location='<?=base_url()?>forum/lists/';">Cancel</button>
				</div>
			</div>
		</form>
	</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				<form method="POST" enctype="multipart/form-data" id="uploadPhotoForm" action="<?php print base_url("forum/uploadPhoto");?>">
...
<script type="text/javascript">
	...
	$("#uploadPhotoForm").submit(function( event ) {
		...
		$("#errorUpload").hide();
		$.ajax({
			url:"<?=base_url("forum/uploadPhoto")?>",
			type:"POST",
