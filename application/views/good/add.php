...
<div class="container">
	<div class="col-sm-12">
		<h2><i class="ion-ios-cart orange"></i> Add Your Items</h2>
		<hr>
		<form action="<?=base_url()?>good/addProcess" method="POST" enctype="multipart/form-data">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				<form method="POST" enctype="multipart/form-data" id="uploadPhotoForm" action="<?php print base_url("good/uploadPhoto");?>">
