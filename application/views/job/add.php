...
<div class="container">
	<div class="col-sm-12">
		<h2><i class="ion-ios-paper-outline"></i> Add Your Job Post</h2>
		<hr>
		<form action="<?=base_url()?>job/addProcess" method="POST" enctype="multipart/form-data">
			<div class="row form-group">
				<label class="col-sm-2">
					Title
				</label>
				<div class="col-sm-8">
					<input type="text" class="form-control" name="title" id="password" onkeyup="keuUpURL(this.value);" required="" placeholder="">
					<input type="hidden" class="form-control" name="url_post" id="url_post" required="" placeholder="">
				</div>
			</div>
			<div class="row form-group">
				<label class="col-sm-2">
				...
				<div class="col-sm-2">
					<div class="input-group">
						...
						<input type="text" class="form-control" name="amount" id="password" required="" placeholder="">
					</div>
				</div>
				<div class="col-sm-2">
			...
			<div class="row form-group">
				...
				<div class="col-sm-3">
					<div class="input-group">
						<span class="input-group-addon" id="basic-addon1"><i class="ion-android-list"></i></span>
			...
			<div class="row form-group">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" name="tags" id="password" required="" placeholder="">
					<p class="help-block">
			...
			<div class="row form-group">
				...
				<div class="col-sm-6">
					<div class="input-daterange input-group" id="datepicker">
						<input type="text" class="input-sm form-control" name="time_open" />
						<span class="input-group-addon">to</span>
						<input type="text" class="input-sm form-control" name="time_close" />
					</div>
				</div>
				<script>
			...
			<div class="row form-group">
				...
				<div class="col-sm-10">
					<div id="photo-area" class="well">
						<input type="hidden" name="uploadphoto" id="uploadphotos">
					...
					<button type="button" class="btn btn-blue" data-toggle="modal" data-target="#uploadphotomodal"><i class="fa fa-camera"></i> Add photo</button>
					<p class="help-block">
						If applicable, You can upload more than 1 photo (flyers or poster)
					</p>
				</div>
			</div>
			<div class="row form-group">
				...
				<div class="col-sm-8">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" name="id_video" id="id_video" required="" placeholder="" readonly>
						<input type="hidden" class="form-control" name="video_thumbnail" id="video_thumbnail" required="" placeholder="" readonly>
					</div>
					<br>
					<div class="input-group">
						<button type="button" class="btn btn-blue" data-toggle="modal" data-target="#uploadvideomodal"><i class="fa fa-video-camera"></i> Upload Video</button>
					</div>
