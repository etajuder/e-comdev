...
$this->menu=array(
	...
	array('label'=>'View Item', 'url'=>array('view', 'id'=>$model->id_post)),
	array('label'=>'Manage Item', 'url'=>array('item')),
);
?>
...
<?php $this->renderPartial('_formupdateitem', array('model'=>$model,'foto'=>$foto)); ?>