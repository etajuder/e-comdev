...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'name_thread'); ?>
		<?php echo $form->textField($model,'name_thread',array('size'=>60,'maxlength'=>64)); ?>
		<?php echo $form->error($model,'name_thread'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'url_thread'); ?>
		<?php echo $form->textField($model,'url_thread',array('size'=>60,'maxlength'=>64)); ?>
		<?php echo $form->error($model,'url_thread'); ?>
	</div>
