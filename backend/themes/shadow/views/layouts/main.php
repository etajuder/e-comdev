	...
	<div id="header">
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			...
			'items'=>array(
				...
				array('label'=>'Data Profil', 'url'=>array('/profil/1')),
				array('label'=>'Data Pengumuman', 'url'=>array('/Pengumuman/admin')),
				array('label'=>'Data Gallery', 'url'=>array('/Gallery/admin')),
				array('label'=>'Data Buku Tamu', 'url'=>array('/bukutamu/admin')),
